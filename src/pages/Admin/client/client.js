                ...
                <div className={cx('client')}>
                    <div className={cx('tagBar')}>
                        ...
                        <select className={cx('selectSort')} name="" id="" onChange={onChangeSelectSort}>
                            ...
                            <option value="a->z">Tên theo thứ tự A - Z</option>
                            <option value="z->a">Tên theo thứ tự Z - A</option>
                        </select>
                    </div>
                                        ...
                                        resultSort.map((product, index) => {
                                            ...
                                            return (
                                                <tr key={index}>
                                                    <td>{index}</td>
                                                    <td>{product.name}</td>
                                                    <td>{product.phone === undefined ? '' : product.phone}</td>
                                                    <td>{product.email}</td>
                                                    <td>
                                                        <span
                                                            className={cx(
