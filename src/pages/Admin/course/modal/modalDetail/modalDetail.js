             ...
             dataCourseDetail.map((product)=>{
                ...
                <div className={cx("rightDetail")}>
                    <div className={cx("infoUser")}>
                        ...
                        <div className={cx("user")}>    
                            <div   className={cx("infoUserLeft")}>
                                <p className={cx("p")}><span> Tên khóa học:</span> {product.name}.</p >
                                <p  className={cx("p")}><span>Giá:</span>  {product.price}.</p>
                                <p className={cx("p")}> <span>Thời gian bắt đầu:</span> {product.start.slice(0,10)}.</p>
                                <p className={cx("p")}><span>Thời gian kết thúc</span> {product.end.slice(0,10)}.</p>
                                <p className={cx("p")} ><span>Trạng thái hoạt động:</span>{product.status}</p>
                    ...
                    <h3>Thông tin Khác</h3>
                        ...
                        <p className={cx("p")}><span>Địa chỉ học:</span> {addressCourse.map((product)=>{
