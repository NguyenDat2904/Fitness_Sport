    ...
    const handleCourseId = () => {
        courseData.forEach((element) => {
            if (element.name === formick.values.course) {
                ...
                setNotificationCourse('Đã thêm khóa học');
                setTimeout(() => {
                ...
                <div className={cx('selectRight')}>
                    <div className={cx('select')}>
                        ...
                        {formick.errors.course && formick.touched.course && (
                            <div className={cx('p')}>
                                <p>{formick.errors.course}</p>
                            </div>
                        )}
                        <p className={cx('notification')}>{notificationCourse}</p>
