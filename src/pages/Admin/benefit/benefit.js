...
const Benefit =()=>{
    ...
    return(
        ...
        <div className={cx('tagBar')}>
            <button onClick={handleStyleFontAddBenefit}><FontAwesomeIcon icon={faPlus} /> Thêm mới</button>
        </div>
                                ...
                                <tr key={indext}>
                                   ...
                                   <td>{product.updatedAt.slice(0,10)}</td>
                                    <td className={cx("detail")}  >
                                        <button className={cx("buttonview")} onClick={()=>handleBenefitId(product._id)} >
                                            <FontAwesomeIcon icon={faEllipsis} />
                                        </button>
                                        <div className={cx(idDetailBenefit!==product._id?"noneTableDetail":"tableDetail")}>
                                           <div className={cx("buttonX")}onClick={()=>handleBenefitId("default")} >
                                             <button >
                                            <FontAwesomeIcon icon={faX} />
                                            </button>
                                           </div>
                                           
                                            <button className={cx("buttonFix")} onClick={()=>handleStyleFontPutBenefit(product._id)}>
