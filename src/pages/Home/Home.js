                            ...
                            <div className={cx('service-contain-readmore')}>
                                <span>
                                    <p>
                                        ...
                                        dựng để mang lại hạnh phúc và tạo ra những khoảnh khắc viên mãn cho bạn trong
                                        cuộc sống bằng việc cung cấp các dịch vụ phát triển sức khỏe thể chất, dinh
                                        dưỡng và tinh thần toàn diện.
                                    </p>
                                </span>
                            </div>
                        </div>
                                ...
                                <div className={cx('item-content')}>
                                    <div className={cx('content')}>
                                        ...
                                        <div className={cx('text')}>
                                            <Link href="#">
                                                Hoà mình vào giai điệu yêu thích và đốt cháy calo với các lớp học nhảy
                                                sôi động. Thoả sức “phiêu” Pop dance, Sexy Dance, Pole dance hoặc Zumba
                                                dưới sự hướng dẫn của các HLV chuẩn Quốc Tế tại California
                                            </Link>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className={cx('item')}>
                                ...
                                <div className={cx('item-content')}>
                                    <div className={cx('content')}>
                                        ...
                                        <div className={cx('text')}>
                                            <Link href="#">
                                                Cùng hàng ngàn hội viên lan toả lối sống lành mạnh ngay hôm nay! Đã đến
                                                lúc bạn nên thử những điều mới mẻ, hướng tới cuộc sống hứng khởi và tự
                                                tin toả sáng
                                            </Link>
                                        </div>
                                    </div>
                                    ...
                                    <div className={cx('content')}>
                                        ...
                                        <div className={cx('text')}>
                                            <Link href="#">
                                                ...
                                                Đạt đến trạng thái cân bằng hoàn hảo bằng cách xây dựng sức mạnh, độ
                                                linh hoạt và sự uyển chuyển cơ thể trong khi thư giãn hoàn toàn mọi giác
                                                quan và giải phóng tâm trí
                                            </Link>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className={cx('content')}>
                                        ...
                                        <div className={cx('text')}>
                                            <Link href="#">
                                                ...
                                                bạn. Đồng thời, các Huấn Luyện Viên Cá Nhân sẽ hướng dẫn bạn từng bước
                                                để chinh phục mục tiêu hình thể đã đặt ra
                                            </Link>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className={cx('item')}>
                                ...
                                <div className={cx('item-content')}>
                                    <div className={cx('content')}>
                                        ...
                                        <div className={cx('text')}>
                                            <Link href="#">
                                                Tận hưởng niềm vui bất tận với hơn 50 lớp tập nhóm bản quyền từ Lesmills
                                                như Body Combat, Body Jam, RPM, SH’Bam và các chương trình độc quyền do
                                                California thiết kế như CaliDrumfit, CaliStep. Các phiên bản mới được
                                                cập nhật liên tục mỗi tháng.
                                            </Link>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className={cx('clb-nearly-left')}>
                        ...
                        <div className={cx('clb-nearly-readmore')}>
                            <span>
                                ...
                                được đầu tư trang thiết bị tốt nhất, khu vực VIP và các tiện ích đặc biệt như Xông hơi,
                                Hồ bơi và Bể sục Jacuzzi.
                            </span>
                            <Link href="#">
                ...
                <div className={cx('story-success')}>
                    <div className={cx('story-success-left')}>
                        ...
                        <div className={cx('story-success-sub-description')}>
                            <span>
                                Trong thập kỷ qua, hơn 350.000 người đã chọn chúng tôi để bắt đầu hành trình tập luyện.
                                Hãy cùng khám phá vì sao California được nhiều hội viên tin tưởng lựa chọn nhé!
                            </span>
                            <Link href="#">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div className={cx('item-text')}>
                                            <h3>
                                                Hội viên Lê Thị Kim Mỹ - Chiến thắng bản thân là chiến thắng hiển hách
                                                nhất
                                            </h3>
                                            <div className={cx('content')}>
                                                "CTC 2022 đã và đang trở thành động lực giúp tôi thay đổi ngoạn mục,
                                                vượt qua giới hạn tuổi tác để thực hiện ước mơ “hot girl” của mình. Chỉ
                                                trong 2 tháng, tôi đã giảm được 8kg mỡ với một sức khoẻ tốt và hình thể
                                                đẹp. Dù đã ngoài tuổi 60 nhưng đi đâu ai cũng dành nhiều lời khen. Từ đó
                                                đã truyền động lực rất lớn đến bản thân tôi và những người xung quanh."
                                            </div>
                                        </div>
                                    </div>
                                </div>
